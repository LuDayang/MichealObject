...
- (void)createView
{
    ...
    //self
    self.frame = CGRectMake(50, 100, kScreenWidth - 100, kScreenHeight - 200);
    ...
    contentLbl.frame = CGRectMake(0, 10, self.bounds.size.width, 30);
    contentLbl.font = [UIFont systemFontOfSize:16.0];
...
//    [cancelBtn setTitleColor:[UIColor blueColor] forState:UIControlStateNormal];
    ...
    for (UIButton *btn in btnRArr) {
        btn.frame = CGRectMake(100, btn_y+ i * (btn_h+btn_mid), btn_w, btn_h);
        i++;
    }
    ...
    sliderLbl.frame = CGRectMake(10, 400, 60, 20);
    sliderLbl.font = [UIFont systemFontOfSize:12.0];
    sliderLbl.backgroundColor = [UIColor clearColor];
    [self addSubview:sliderLbl];

    //penBoldSlider
    penBoldSlider = [[UISlider alloc]init];
    penBoldSlider.frame = CGRectMake(70+10, 400, 180, 20);
    ...
    self.drawView=[[MyView alloc]initWithFrame:CGRectMake(10, 150, self.bounds.size.width - 20, 150)];
